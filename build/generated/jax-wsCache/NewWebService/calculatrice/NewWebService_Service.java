 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://calculatrice/", wsdlLocation = "http://localhost:8080/calculatrice/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://calculatrice/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculatrice/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://calculatrice/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculatrice/", "NewWebServicePort"), NewWebService.class, features);
    }
